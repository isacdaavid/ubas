...
Welcome to `schiz_wholebrain` contributor's guide.
...
If you experience bugs or general issues with `schiz_wholebrain`, please have a look
...
You can help improve `schiz_wholebrain` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`schiz_wholebrain` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `schiz_wholebrain`'s files. While this mechanism can
...
```
conda create -n schiz_wholebrain python=3 six virtualenv pytest pytest-cov
conda activate schiz_wholebrain
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/schiz_wholebrain.git
   cd schiz_wholebrain
   ```
...
5. Install [pre-commit]:
   ...
   `schiz_wholebrain` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/schiz_wholebrain
[issue tracker]: https://github.com/<USERNAME>/schiz_wholebrain/issues
