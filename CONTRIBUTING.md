...
Welcome to `ubas` contributor's guide.
...
If you experience bugs or general issues with `ubas`, please have a look
...
You can help improve `ubas` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ubas` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ubas`'s files. While this mechanism can
...
```
conda create -n ubas python=3 six virtualenv pytest pytest-cov
conda activate ubas
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ubas.git
   cd ubas
   ```
...
5. Install [pre-commit]:
   ...
   `ubas` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ubas
[issue tracker]: https://github.com/<USERNAME>/ubas/issues
